...
namespace TusaBulkyBook.DataAccess.DbInitializer
{
    public class DbInitializer : IDbInitializer
    {
        ...
        public void Initialize()
        {
            ...
            if (!_roleManager.RoleExistsAsync(SD.Role_Customer).GetAwaiter().GetResult())
            {
                ...
                ApplicationUser applicationUser = _db.ApplicationUsers.FirstOrDefault(u => u.UserName == "amtuska@gmail.com");
